...
A rigorous research program with explicit implementation and validation details for constructing quantum computers inside of human cells with biomolecules (proteins and ligands)
